    ...
    <DefaultLayout>
      ...
      <div className="inline-flex rounded-md shadow-sm">
        <Link
          ...
          className="rounded-s-lg border border-gray-200 bg-white px-4 py-2 text-sm font-medium text-gray-900 hover:bg-gray-100 focus:z-10 focus:text-green-500 focus:ring-2 focus:ring-green-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white dark:focus:text-white dark:focus:ring-green-500"
        >
          Matches
        </Link>
        <Link
          href={`/tournament/details`}
          className="border-b border-t border-gray-200 bg-white px-4 py-2 text-sm font-medium text-green-500 hover:bg-gray-100 hover:text-green-500 focus:z-10 focus:text-green-500 focus:ring-2 focus:ring-green-500 dark:border-gray-700 dark:bg-gray-800 dark:text-white dark:hover:bg-gray-700 dark:hover:text-white dark:focus:text-white dark:focus:ring-green-500"
        >
          Standings
        </Link>
      </div>
