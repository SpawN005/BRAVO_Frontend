  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      const response = await authService.register({
        // Assuming your API expects these fields
      ...
      <div className="rounded-sm border border-stroke bg-white shadow-default dark:border-strokedark dark:bg-boxdark">
        ...
        <div className="hidden w-full xl:block xl:w-1/2">
            <div className="h-screen px-26 py-17.5 text-center">
              ...
              <Image src={'/images/fans.svg'} height={250} width={400} alt="dfd"></Image>
              </span>
            </div>
          </div>

          <div className=" border-stroke dark:border-strokedark xl:w-1/2 xl:border-l-2">
            <div className="w-full p-2  xl:px-17.5">
              <span className="mb-1.5 block font-medium">Start for free</span>
              <h2 className="mb-9 text-2xl font-bold text-black dark:text-white sm:text-title-xl2">
                Sign Up to LinkUp Tournament
              </h2>
