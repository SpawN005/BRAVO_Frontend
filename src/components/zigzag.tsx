...
import FeatImage01 from '../../public/images/bg1.png'
import FeatImage02 from '../../public/images/bg1.png'
import FeatImage03 from '../../public/images/bg1.png'
            ...
            <div className="md:grid md:grid-cols-12 md:gap-6 items-center">
              ...
              <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <div className="font-architects-daughter text-xl text-green-500 mb-2">More speed. Less spend</div>
