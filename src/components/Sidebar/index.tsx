...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  const userDetails: any = getUserFromToken();
  const userPermissionLevel = userDetails ? userDetails.permissionLevel : null;
                ...
                <>
                  ...
                  <li>
                    <Link
                      ...
                      className={`group relative flex items-center gap-2.5 rounded-sm px-4 py-2 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 `}
                    >
<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#ffffff" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M3 15h18"/></svg>
                 Stadiums
                    </Link>
                  </li>
                  {/* <!-- Menu Item referees --> */}
