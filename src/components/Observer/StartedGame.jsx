    ...
    const handleGameEvent = (event) => {
        switch (event) {
            ...
            case 'half':
                ...
                setCurrentHalf(currentHalf === 'first half' ? 'second half' : 'extra time');
                break;
            case 'finish':
                    ...
                    <div className="column">
                        <div className="match-details">
                            ...
                            <div className="match-score">
                                <span className="match-score-number match-score-number--leading">{scoreTeam1}</span>
                ...
                <Grid.Column textAlign="right" className="actions">
                    <Button.Group>
                        ...
                        <Button onClick={() => handleGameEvent('half')}>
                            {currentHalf === 'first half' ? 'Mi-temps' : 'Deuxième mi-temps'}
                        </Button>
