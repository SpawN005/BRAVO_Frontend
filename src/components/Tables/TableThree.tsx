...
const TeamDetails = () => {
  ...
  if (teamData && teamData.players) {
    for (
      let i = 1;
      i <= Math.ceil(teamData.players.length / playersPerPage);
      i++
    ) {
      pageNumbers.push(i);
    }
  ...
  return (
    <div className="max-w-full overflow-x-auto">
      <form className=" mx-1 mb-3 flex items-center justify-between">
        ...
        <div className="relative max-w-md flex-1 justify-end">
          ...
          <button
            type="submit"
            className="absolute bottom-2.5 end-2.5 rounded-lg bg-green-500 px-4 py-2 text-sm font-medium text-white hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-green-500 dark:focus:ring-blue-800"
          >
            Search
          </button>
        </div>
        <button
          ...
          className=" justify-items-end rounded bg-green-500 p-2 font-normal text-white    hover:bg-opacity-90"
        >
          <svg
            className="h-6 w-6"
            fill="none"
      ...
      {showAddPlayerPopup && (
        <div className="fixed inset-0 flex items-center justify-center bg-gray-800 bg-opacity-50">
          <div className="h-80 w-150 rounded-md bg-white p-9">
            ...
            <form onSubmit={handleSubmit(handleAddPlayer)}>
              ...
              <div className="mt-4 flex justify-end">
                <button
                  type="button"
                  onClick={() => setShowAddPlayerPopup(false)}
                      ...
                      <td className="border-b border-[#eee] px-4 py-5 dark:border-strokedark">
                        <div className="flex items-center space-x-3.5">
                          ...
                          <button
                            ...
                            className="bg-red rounded bg-red-700 px-2 py-1 font-bold text-white"
                          >
                            <svg
                              className="fill-current"
                              width="18"
            ...
            <form>
              ...
              <div className="flex justify-end">
                <button
                  ...
                  className=" mr-2 rounded bg-red-700 px-2 py-1 font-bold text-white"
                >
                  Cancel
                </button>
                <button
      ...
      <div className="mt-4 flex justify-center">
        {pageNumbers.map((number) => (
          <button
            ...
            className={`mx-1 rounded bg-gray-200 px-4 py-2 font-semibold text-gray-800 ${currentPage === number ? "bg-gray-400" : ""}`}
          >
            {number}
          </button>
        ))}
