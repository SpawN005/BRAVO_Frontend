...
const DatePickerTwo = forwardRef(
  ({ mindate, maxdate, onSelectChange, ...props }, ref) => {
    useEffect(() => {
      // Init flatpickr
      flatpickr(".form-datepicker", {
        ...
        minDate: mindate, // Minimum allowed date
        maxDate: maxdate,
        onChange: onSelectChange, // Call onSelectChange callback on date change
      });
    }, [mindate, maxdate, ref, onSelectChange]);
