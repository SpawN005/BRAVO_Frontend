...
export default function FooterActions() {
    ...
    const handleExtraTimeChange = (e) => {
        ...
        setSelectedExtraTime(value === 'custom' ? prompt('Enter custom extra time (minutes):', '') : parseInt(value, 10));
    };
    ...
    const renderButton = (text) => (
        <button
            ...
            className={`text-white font-bold py-2 px-4 rounded ${buttonColor(text)}`}
        >
            {text}
        </button>
    );
    ...
    return (
        <div className="space-x-2 flex justify-center gap-12 items-center">
