        ...
        <div className="flex justify-center items-center h-full">
            {stadium ? (
                <div className="w-full max-w-lg p-8 bg-white rounded-lg shadow-lg">
                    <div id="map" className="h-48 mb-4 rounded-lg overflow-hidden"></div>
                    <h1 className="text-2xl font-bold mb-4">{stadium.name}</h1>
                    <p className="mb-2"><span className="font-semibold">Address:</span> {stadium.address}</p>
                    <p className="mb-2"><span className="font-semibold">Capacity:</span> {stadium.capacity}</p>
                    <p><span className="font-semibold">Available:</span> {stadium.isAvailable ? 'Yes' : 'No'}</p>
                </div>
            ) : (
